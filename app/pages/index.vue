...
const stats = computed(() => [
  { num: '6,125+', label: t('Confirmed dead', 'Muertos confirmados') },
  { num: '61,000+', label: t('Injured', 'Heridos') },
...
<template>
  ...
  <section class="py-20 px-8 bg-white">
    <div class="max-w-215 mx-auto">
      ...
      <p class="text-[1.05rem] text-ink-light leading-[1.8] max-w-170 mb-5">
        {{ t(
      ...
      <blockquote class="border-l-[3px] border-primary pl-6 py-4 my-8 bg-paper">
        ...
        <cite class="block mt-2 text-[0.78rem] not-italic tracking-wider uppercase text-muted">
          {{ t(
      ...
      <p class="text-[1.05rem] text-ink-light leading-[1.8] max-w-170">
        {{ t(
  ...
  <section class="py-20 px-8 bg-ink text-white">
    <div class="max-w-215 mx-auto">
      ...
      <p class="text-[1.05rem] text-white/60 max-w-160 leading-[1.8] mb-12">
        {{ t(
      ...
      <div class="grid grid-cols-1 sm:grid-cols-3 border border-white/8">
        <div
          v-for="(card, i) in contextCards"
          :key="i"
          class="p-8 border-r border-b border-white/8 sm:border-b-0 sm:last:border-r-0"
        >
          <div class="font-serif text-[2.2rem] font-bold text-accent leading-none mb-2">{{ card.num }}</div>
          <div class="text-[0.72rem] tracking-widest uppercase text-white/35 mb-3">{{ card.label }}</div>
  ...
  <section class="py-20 px-8 bg-paper">
    <div class="max-w-215 mx-auto">
      ...
      <p class="text-[1.05rem] text-ink-light max-w-165 leading-[1.8] mb-10">
        {{ t(
      ...
      <p class="text-[0.85rem] text-muted leading-[1.6] max-w-150">
        {{ t(
  ...
  <section class="py-20 px-8 bg-primary text-white text-center">
    <div class="max-w-215 mx-auto">
      ...
      <p class="text-[1rem] text-white/80 max-w-130 mx-auto mb-8 leading-[1.7]">
        {{ t(
  ...
  <section class="py-20 px-8 bg-white">
    <div class="max-w-215 mx-auto">
      ...
      <h2 class="font-serif text-[clamp(1.6rem,3.5vw,2.2rem)] leading-tight mb-4 text-ink">
        {{ t("Why we're directing donations to Direct Relief.", 'Por qué dirigimos las donaciones a Direct Relief.') }}
      </h2>
      <p class="text-[1rem] text-ink-light leading-[1.8] max-w-165 mb-4">
        {{ t(
      ...
      <p class="text-[1rem] text-ink-light leading-[1.8] max-w-165">
        {{ t(
